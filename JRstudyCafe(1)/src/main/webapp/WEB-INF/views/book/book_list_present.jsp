...
<body>
	...
	<div id="content_wrap">
		<div class="card">
		 ...
		 <div class="subtap2">
			<ul>
				<li style="cursor:Pointer; width:230px;" class="on" onclick="location.href='${conPath }/bookListView_present.do">예약내역</li>
				<li style="cursor:Pointer; width:230px;" class="" onclick="location.href='${conPath }/bookListView_past.do">과거이용내역</li>
