...
INSERT INTO ROOM (R_NO, R_NAME, R_IMAGE, R_PPR, R_PPH, R_STATUS)
            VALUES(R_NO_SQ.NEXTVAL, '810호', '배경.jpg', '4', '2000', 1);
...
select * from room order by r_name;
SELECT * FROM (SELECT ROWNUM RN, R.* FROM (SELECT * FROM ROOM) R) M, ROOMOPTION O WHERE M.R_NO = O.R_NO AND RN BETWEEN 1 AND 10;
